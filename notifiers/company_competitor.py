...
from entities import CompanyCompetitor
from notifiers.base import BaseNotifier


class CompanyCompetitorNotifier(BaseNotifier):

    def __init__(self, entity_obj: Optional[CompanyCompetitor], original_entity_obj: Optional[CompanyCompetitor]):
